...
public class DisplayMessageLoggerDecorator : Message
{
    private readonly LoggerBase logger;

    public DisplayMessageLoggerDecorator(Message message, LoggerBase logger)
        : base(message)
    {
        this.logger = logger;
    }
    ...
    {
        logger.LogMessage("Дисплей", $"{message}");
    }
}