...
public class MessengerMessageLoggerDecorator : Message
{
    private readonly LoggerBase logger;

    public MessengerMessageLoggerDecorator(Message message, LoggerBase logger)
        : base(message)
    {
        this.logger = logger;
    }
    ...
    {
        logger.LogMessage("Мессенджер", $"{message}");
    }
}